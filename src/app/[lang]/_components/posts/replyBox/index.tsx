...
import Modal from '@components/posts/replyBox/modal';
import ReplyItem from '@components/posts/replyBox/replyItem';
import Skeleton from '@components/posts/replyBox/skeleton';
