...
import RepliesBox from '@components/posts/replyBox';
import AddReplyBox from '@components/posts/replyBox/addReplyBox';
      ...
      {comment.deletedAt ? (
        ...
        <>
          ...
          {showReply === comment.id && (
            <AddReplyBox showReply={showReply} setShowReply={setShowReply} />
          )}
        </>
      )}
      {comment.repliesCount !== 0 && showReplies && (
        <RepliesBox commentId={comment.id} />
      )}
    </div>
  );
}
